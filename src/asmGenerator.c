...
{
  fprintf(p_outFile, "\tmov\trax, %s\n", reglist[r1]);
  fprintf(p_outFile, "\tcqo\n");
  fprintf(p_outFile, "\tidiv\t%s\n", reglist[r2]);
  fprintf(p_outFile, "\tmov\t%s, rax\n", reglist[r1]);
  free_register(r2);
  return(r1);
}
